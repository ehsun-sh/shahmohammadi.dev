/**
 * Copies the Open Sans variable webfont out of node_modules into public/fonts/.
 *
 *   npm run fonts
 *
 ...
 *
 * Regenerate whenever @fontsource-variable/open-sans is upgraded. The version
  ...
  if (!fs.existsSync(source)) {
    throw new Error(
      `${source} is missing. Run \`npm install\` first — the font comes from ` +
        `@fontsource-variable/open-sans, it is not vendored in this repo.`,
    );
  }
